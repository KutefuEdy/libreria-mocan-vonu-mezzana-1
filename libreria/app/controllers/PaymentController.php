...
class PaymentController {
  ...
  public function index() {
    ...
    $summary = ['customers'=>$m['customers'] ?? 0];
  ...
  public function update($id) {
    ...
    (new \App\Models\Log())->addAction('update_payment', \App\Core\Auth::user()['id'] ?? null, ['customer_id'=>$_POST['customer_id'] ?? null, 'note'=>($_POST['amount'].' '.$_POST['paid_at'])]);
    \App\Services\ViewCardService::refreshPayments();
    \App\Services\ViewCardService::refreshCustomers();
    Helpers::redirect('/payments');
  }
