...
<head>
  ...
  <link rel="stylesheet" href="<?php echo Helpers::url('public/assets/css/app.css'); ?>" />
  ...
  <style>
    body.link-sidebar .left-sidebar.with-vertical { position: fixed; top: 0; left: 0; height: 100vh; }
  </style>
  <link rel="stylesheet" href="<?php echo Helpers::url('public/libs/simplebar/dist/simplebar.min.css'); ?>">
</head>
        ...
        <div>
          ...
          <nav class="sidebar-nav scroll-sidebar" data-simplebar>
            <ul class="sidebar-menu" id="sidebarnav">
              ...
              <li class="sidebar-item">
                <a class="sidebar-link" href="<?php echo Helpers::url('/libri'); ?>" aria-expanded="false">
                  <iconify-icon icon="solar:book-line-duotone"></iconify-icon>
                  <span class="hide-menu">Libri</span>
                </a>
              </li>
              <?php if (Auth::isAdmin()) { ?>
              <li class="sidebar-item">
